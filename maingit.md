...
- [Основы работы с удаленным репозитарием](#Основы-работы-с-удаленным-репозитарием)
  ...
  * [git fetch и git pull — забираем зменения из центрального репозитария](#git-fetch-и-git-pull-—-забираем-изменения-из-центрального-репозитария)
...
- [Рецепты](#Рецепты)
  * [Создание пустого репозитория на сервере](#Создание-пустого-репозитория-на-сервере)
  * [Импорт svn репозитория на Git-сервер](#Импорт-svn-репозитория-на-Git-сервер)
  * [Связка локальной и удаленной ветки](#Связка-локальной-и-удаленной-ветки)
  * [Создание новой пустой ветки](#Создание-новой-пустой-ветки)
  * [Использование Git для получения версии](#Использование-Git-для-получения-версии)
