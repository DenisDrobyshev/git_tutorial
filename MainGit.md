...
Данная команда позволяет выбрать файлы, которые должны присутствовать в вашем
рабочем дереве. 

Устанавливает присутствие my/dir1/ и sub/dir2/ в рабочем деревк (плюс все файлы 
