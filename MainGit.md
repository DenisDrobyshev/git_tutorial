...
### git sparse-checkout - сокращение отслеживаемых файлов в рабочем дереве

Данная команда позволяет выбрать файлы, которые должны присутствовать в рабочем 
дереве. 

Устанавливает присутствие my/dir1/ и sub/dir2/ в рабочем дереве (плюс все файлы 
непосредственно под my/, sub/ и каталог верхнего уровня):
```
git sparse-checkout disable
```


Перезаполнит рабочий каталог всеми файлами, отключив сокращённое отслаживание 
файлов:
```
git sparse-checkout set my/dir1 sub/dir2
```

Добавит присутствие всех файлов, находящиеся в каталоге some/dir/dir1 (на любой глубине), 
а также всех файлов, находящиеся непосредственно под some/dir/ и непосредственно под 
some/. Перед использованием этой команды необходимо уже находиться в режиме сокращённого 
отслеживания файлов в рабочем дереве:
```
git sparse-checkout add some/dir/dir1
```

Для просмотра отслеживаемых каталогов в рабочем дереве необходимо выполнить:
```
git list
```
